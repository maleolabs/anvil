...
| Command | Description |
|---|---|
| `anvil adapter list` | List available adapters with deployment model and version (`--json`) |
...
| Command | Description | Flags |
|---|---|---|
| `anvil adapter list` | List available adapters (deployment model, version) | `--json` |
