...
// is a parent-only namespace (ADR-010 §6.7) with the list, inspect, and
// use subcommands registered.
//
// Reference: TS-007-031, TS-007-032, TS-007-033
func TestAdapterCommand_RegistersSubcommands(t *testing.T) {
	...
	for _, want := range []string{"list", "inspect", "use"} {
		if !registered[want] {
