...
// directory without anvil.yaml with a clear error.
//
// Reference: TS-007-033 AC-6
...
// TestAdapterUse_UnknownAdapter verifies that an unknown adapter name is
// rejected before any change, listing the known adapters.
//
// Reference: TS-007-033 AC-7
