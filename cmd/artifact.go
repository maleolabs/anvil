...
func runPackage(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		fmt.Fprintf(cmd.ErrOrStderr(), "Error: could not package artifact: %v.\n", err)
		return err
	}
	...
	fmt.Fprintln(cmd.OutOrStdout(), "Ready for verification and release.")
