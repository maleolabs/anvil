...
func TestProjectStatus_RemovedProject(t *testing.T) {
	...
	// Simulate project removal by deleting the project directory. The
	// "anvil project remove" command itself was removed as an undocumented
	// subcommand (TS-019-04-02); the removal behavior under test is the
	// post-removal state, which is reproduced here directly.
