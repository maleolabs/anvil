...
// (TS-008-008 command context, decision 021). The legacy "runtime" group
// stays under Server Runtime until it is removed (deprecated, ADR-014).
//
// Reference: ST-P8-01, ADR-010 §6
var rootDomainGroups = []domainGroup{
	{
		Name:     "Development",
		Commands: []string{"init", "status", "project", "config", "artifact", "pipeline", "adapter"},
	},
	{
		Name:     "Deployment",
