...
//
// DEPRECATED: use "anvil server readiness" instead (ADR-021 migration table).
//
// Reference: ST-P5-02
...
DEPRECATED: "anvil runtime readiness" is deprecated. Use "anvil server
readiness" instead (ADR-021 migration table, docs/migration-guide-v1.5.md).
This command is retained for backward compatibility and will be removed in a
...
It does not require an Anvil project context.`,
  ...
  anvil runtime readiness --install-root /opt/anvil`,
	Deprecated:   `use "anvil server readiness" instead (see docs/migration-guide-v1.5.md)`,
	SilenceUsage: true,
	RunE:         runReadiness,
}
