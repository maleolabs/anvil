...
func runInstall(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		fmt.Fprintf(cmd.ErrOrStderr(), "Error: could not create Release: %v.\n", err)
		return err
	}
...
func runHistory(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		fmt.Fprintf(cmd.ErrOrStderr(), "Error: Release %q not found: %v.\n", releaseID, err)
		return err
	}
...
func runActive(cmd *cobra.Command, args []string) error {
	...
	if err != nil {
		fmt.Fprintf(cmd.ErrOrStderr(), "Error: could not query Active Release: %v.\n", err)
		return err
	}
