...
// empty declaration — no phases, no checks, no commands — registers
// fine: an adapter that declares no capabilities is handled gracefully
// (TS-P7-07 AC-4).
//
// Reference: TS-P7-07 AC-1, AC-2, AC-3, AC-4
