...
// verification checks during artifact verification (EPIC-003 §7.5), and
// capability requests when collecting an adapter's declared capabilities
// (TS-P7-07). It reads the framework's declared capabilities to
...
// ADR-009 §9.6).
//
// Reference: TS-P7-08, TS-P7-07, ADR-009 §6.3
