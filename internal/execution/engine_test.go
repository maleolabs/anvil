...
func TestEngine_Load_ValidPipeline(t *testing.T) {
	...
	path := writePipelineYAML(t, testCIPipeline())
...
// TestEngine_Execute_EmptyStagesPipeline verifies that executing a build
// pipeline with empty stages succeeds with a "success" status.
