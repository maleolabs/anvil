...
// testCIPipeline returns a CI-style PipelineDefinition fixture for tests
// (build stage with one task, test stage with three placeholder tasks).
// It is a test-local fixture — the Core-owned default CI template data
// was removed from the runtime (TS-015-01-02, ADR-026): pipeline content
// is distribution content supplied by delivery lifecycle standards, never
// engine content (A10).
func testCIPipeline() PipelineDefinition {
