...
// the injectable artisan command runner used by activation phases.
//
...
// (runArtisan — os/exec). Tests construct &Adapter{runner: fakeRunner}
// to execute phases without PHP on the host.
func New() *Adapter {
