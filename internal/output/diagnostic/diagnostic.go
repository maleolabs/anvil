...
//
// Scope note (Platform-036, TS-015-05-02): the recommendations-style and
...
//
// Reference: TS-P9-08, TS-P9-09, Platform-010 §7.1/§7.2, EPIC-009 §8.2/§8.4
package diagnostic
...
//
// Scope note (Platform-036, TS-015-05-02): the Contexts and Recommendations
...
//
// Reference: TS-P9-08, Platform-010 §7.1, EPIC-009 §8.4
...
//
// Reference: TS-P9-09, TS-P8-05, Platform-010 §7.2/§8.5, EPIC-009 §8.4
