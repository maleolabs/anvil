...
// and the adapters (internal/flutter) both consume it. Platform
// detection originally lived in internal/flutter (TS-P7-22) and was
// relocated here by TS-P7-23 because the Core pipeline engine must not
// depend on adapters (ADR-009 §8.1). internal/flutter re-exports the
// identifiers and functions for backward compatibility.
//
// Reference: TS-P7-23, ADR-018, ADR-009 §8.1
package platform
