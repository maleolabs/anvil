...
// host.
//
// The behavior is relocated from the former internal/flutter (TS-P7-22)
// unchanged: the pipeline engine (internal/execution) consumes this
// package because Core must not depend on adapters (ADR-009 §8.1).
package platform
