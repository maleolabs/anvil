...
//   - strict format layer the schema marks advisory: https-only
...
func Parse(data []byte) (*ParseResult, error) {
	...
	// Root additionalProperties: the schema declares exactly these fields.
	rejectUnknownFields(root, rootFieldNames, "", &errs)
