...
// StateMachine tracks a Release's progression through its lifecycle stages.
//
...
//
// Valid transitions (from ADR-003 §4):
//
//	Ready → Activating
//	Activating → Active, RollingBack, Failed
//	Active → RollingBack, Archived
...
// new state at path — never a truncated state machine file (TD-002).
//
// Reference: TS-P4-04, TD-002
