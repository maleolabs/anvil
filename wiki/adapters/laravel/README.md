...
> **Important:** the Anvil installer (`install.sh`) and release builds do **not** ship the adapter binary yet. Build it manually once (see below). This is tracked in [limitations](../limitations.md).
