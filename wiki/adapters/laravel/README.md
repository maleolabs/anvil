...
|---|---|
| **Init template** | `anvil init my-app --framework laravel` fetches the Laravel build pipeline from the adapter's `template` command (ADR-020) and writes framework-aware project config ([init.md](init.md)) |
