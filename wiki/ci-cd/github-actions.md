...
The generated `.anvil/pipelines/build.yaml` for Laravel runs: Composer install --> npm install --> npm run build --> artisan cache commands. See [Laravel build pipeline](https://github.com/maleolabs/anvil-standard-laravel/blob/develop/docs/build.md) for details.
