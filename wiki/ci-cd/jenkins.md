...
```bash
anvil server release install $ANVIL_PROJECT_ID .anvil/artifacts/*.tar.gz   # or: anvil deployment install <artifact-path>
anvil server release activate $ANVIL_PROJECT_ID <release-id>                # or: anvil deployment activate <project-id> <release-id>
```
